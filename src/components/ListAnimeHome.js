...
const Cart = ({data}) => {
  ...
  return (
      <Pressable style={styles.content} onPress={() =>navigation.navigate('Details',{slug:data?.slug||''})}>
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.viewAll} onPress={() =>{
